  ...
  mk: {
    translation: {
      ...
      about: {
        ...
        filters: "Преку едноставни начини на филтрирање, на било кој корисник му е овозможено да го добие бараниот преглед на сегмент од податоците и да донесе заклучок за квалитетот на работењето на одредено јавно претпријатие или трговско друштво. Оделените профилни страници за секое јавно претпријатие или трговско друштво пак, овозможуваат севкупен преглед на работата низ годините за коишто се достапни податоците.",
        ...
        dataSourceLink: "Изменетите податоци",
        ...
        sourceCodeDesc: "на оваа компјутерска презентација е објавен на мрежата GitHub и слободно достапен за корекции на сите заинтересирани страни под условите предвидени во лиценцата.",
        ...
        updates: "Податоците се ажурираат повремено, соодветно на објавите на Министерството за финансии на Република Северна Македонија.",
        ...
        responsibilityFix: "Доколку сметате дека некаде е направена грешка и потребна е исправка, љубезно",
  ...
  en: {
    translation: {
      ...
      about: {
        ...
        sourceCodeDesc: "of this computer presentation is published on GitHub and freely available for corrections by all interested parties under the terms of the license.",
        licenseTitle: "License",
        licenseDesc: "The source code of this computer presentation can be freely used under the terms of the license",
        updatesTitle: "Updates",
        updates: "Data is updated periodically, in accordance with announcements from the Ministry of Finance of the Republic of North Macedonia.",
